...
<html>
  ...
  <ul class="nav nav-pills">
	...
	<li class="active col-sm-1"><a href="successLogin.jsp"><b>主页</b></a></li>
	...
	<li class="col-sm-2"><a href="manager/review/myreview.jsp"><b>我的评论</b></a></li>
	<li class="col-sm-2"><a onclick="openUrl('personalizedrecommendation.jsp')"><b>个性化推荐</b></a></li>
</ul>
    <div class="col-sm-offset-7 col-sm-5 text-danger">
    <% String name = (String)session.getAttribute("username"); %>
    尊敬的客户：<%=name%>您好!
    </div>
<form class="form-vertical" role="form" action="BusinessSearchServlet" method="post">
	<div class="form-group">
		
		<input type="text" name="search">
        <label class="control-label">搜索类型：</label>
				<input type="radio" name="searchType" value="like" checked />模糊搜索（输入酒店的特色，例如：商业出行,休闲度假，食物等）
				<input type="radio" name="searchType" value="all" />准确搜索(输入酒店名称)
...
<table class="table">
   <thead>
	...
	<td>
 	...
 	<td>
 	<a onclick="openUrl('manager/review/reviewadd.jsp')"><font color="#FF0000">评论</font></a>
	 </td>
 	<%
	}
 	%>
